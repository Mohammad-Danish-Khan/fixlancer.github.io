  ...
  let slides = [
    {
      key: uuidv4(),
      content: (
        <img src="https://api.thefamoustoken.com/images/cards_06.png" alt="1" />
      )
    },
    {
      key: uuidv4(),
      content: (
        <img src="https://api.thefamoustoken.com/images/cards_02.png" alt="2" />
      )
    },
    {
      key: uuidv4(),
      content: (
        <img src="https://api.thefamoustoken.com/images/cards_03.png" alt="3" />
      )
    },
    {
      key: uuidv4(),
      content: (
        <img src="https://api.thefamoustoken.com/images/cards_01.png" alt="4" />
      )
    }
  ].map((slide, index) => {
